...
class CoverViewSet(CreateModelMixin, DestroyModelMixin, ListModelMixin, RetrieveModelMixin, UpdateModelMixin,
                   GenericViewSet):
...
class PublishingHouseViewSet(CreateModelMixin, DestroyModelMixin, ListModelMixin, RetrieveModelMixin, UpdateModelMixin,
                             GenericViewSet):
    filter_fields = ['active']
    permission_classes = [AllowAny]
